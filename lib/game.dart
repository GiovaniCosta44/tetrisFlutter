...
// Contagem de quantos subblocks tem em cada linha

    oldSubBlocks.forEach((subBlock) {
        rows.update(subBlock.y, (value) => ++value, ifAbsent: () => 1);
     });

// Adicionar score quando encontrar uma linha completa
  ...
  Widget ? drawBlocks(){
    ...
    oldSubBlocks.forEach((oldSubBlock) {
      subBlocks.add(getPositionedSquareContainer(oldSubBlock.color, oldSubBlock.x, oldSubBlock.y));
    });
